...
parser.add_argument('-p','--pitchp', help="PitchP", required=True, type=float, dest='p')
parser.add_argument('-rp','--rpdiff', help="PitchP", required=False, type=float, default=0.15, dest='rp')

args = parser.parse_args()
pitchp = float(args.p)
rpdiff = float(args.rp)
#pitchp = input("Input P value for Pitch axis: ")
